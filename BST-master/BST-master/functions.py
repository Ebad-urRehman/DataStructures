...
# bst = BST()
# root_value = int(input("Enter root Node: "))
# bst.insert_node(root_value)
...
# value = int(input("Enter root Node: "))
# bst.insert_node(value)
# print(bst.root.node_data)
# print(bst.root.left.node_data)
# print(bst.root.left.left.node_data)
# print(bst.root.left.left.left.node_data)
# print(bst.root.right.node_data)
# bst.del_node(int(input("Enter a node to delete!")))
# print(bst.root.node_data)
# print(bst.root.left.node_data)
# print(bst.root.left.left.node_data)
# print(bst.root.left.left.left.node_data)
